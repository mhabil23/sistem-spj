...
<div style="display: grid; grid-template-columns: 1fr; gap: 1.5rem; margin-top: 1.5rem;">
    ...
    <div class="panel">
        <div class="panel-header">
            ...
            <a href="{{ route('bendahara.spj.index') }}">Lihat Semua →</a>
        </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('bendahara.spj.show', $spj->id) }}" class="btn-primary" style="padding: 0.25rem 0.75rem; font-size: 0.875rem; text-decoration: none;">Periksa</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
