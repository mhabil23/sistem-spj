<aside class="sidebar">
    <div class="sidebar-header" style="padding: 1.5rem;">
        ...
        <div style="margin-left: 0.75rem;">
            ...
            <span style="font-size: 0.75rem; color: #64748b;">Panel ppspm</span>
        </div>
    </div>
    ...
    <nav class="sidebar-nav" style="padding: 1rem;">
        ...
        <a href="{{ route('ppspm.dashboard') }}" class="nav-item {{ request()->routeIs('ppspm.dashboard') ? 'active' : '' }}">
        ...
        <a href="{{ route('ppspm.spj.index') }}" class="nav-item {{ request()->routeIs('ppspm.spj.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('ppspm.riwayat.index') }}" class="nav-item {{ request()->routeIs('ppspm.riwayat.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('ppspm.profil.index') }}" class="nav-item {{ request()->routeIs('ppspm.profil.*') ? 'active' : '' }}">
