...
<div class="page-heading">
    <div>
        ...
        <p>Seluruh dokumen yang sudah melewati meja verifikasi Umum.</p>
    </div>
</div>

<div class="panel" style="margin-bottom: 20px; padding: 20px;">
    <form action="{{ route('umum.riwayat.index') }}" method="GET" style="display: flex; gap: 15px; align-items: flex-end; flex-wrap: wrap;">
        ...
        <div>
            <a href="{{ route('umum.riwayat.index') }}" style="display: inline-block; padding: 8px 16px; font-size: 12px; color: #ef4444; text-decoration: none; font-weight: 600; border: 1px solid #fee2e2; border-radius: 8px; background: #fef2f2;">Reset</a>
        </div>
        @endif
    </form>
</div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('umum.spj.show', $spj->id) }}" style="color: #2563eb; font-weight: 600; text-decoration: none;">{{ $spj->nomor_spj }}</a></td>
                    ...
                    <td>
                        <form action="{{ route('umum.riwayat.destroy', $spj->id) }}" method="POST" onsubmit="return confirm('Anda yakin ingin menghapus permanen riwayat pengajuan ini?');" style="display:inline;">
                            @csrf
                            @method('DELETE')
