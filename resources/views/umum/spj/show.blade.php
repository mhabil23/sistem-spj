...
<div class="page-heading">
    ...
    <div style="display: flex; gap: 10px;">
        <a href="{{ route('umum.spj.print', $spj->id) }}" target="_blank" class="btn-primary" style="background-color: #059669; text-decoration: none; display: flex; align-items: center; gap: 5px;">
            <ion-icon name="print-outline" style="font-size: 1.25rem;"></ion-icon> Cetak Lembar Checklist
        </a>
        <a href="{{ route('umum.spj.index') }}" class="btn-primary" style="background-color: #6b7280; text-decoration: none;">
            Kembali
        </a>
    </div>
</div>
...
@endphp
@if($waktuMulai)
<div class="panel" style="margin-bottom: 2rem; background: #f0fdf4; border: 1px solid #bbf7d0;">
    <div style="padding: 1rem 1.5rem; display: flex; justify-content: space-between; align-items: center;">
        <div>
            <strong style="color: #166534; display: flex; align-items: center; gap: 5px; margin-bottom: 0.25rem;">
        ...
        <div>
            <strong style="color: #166534; font-size: 1.125rem;">
                @php
    ...
    <div style="padding: 1rem 1.5rem; border-top: 1px solid #bbf7d0;">
        <strong style="color: #166534; display: block; font-size: 0.875rem; margin-bottom: 0.25rem;">Catatan Internal untuk PPK:</strong>
        <p style="margin: 0; color: #15803d; font-size: 0.875rem; white-space: pre-line;">{{ $spj->catatan_internal }}</p>
    </div>
    @endif
</div>
@endif
